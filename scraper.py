...
# Set up variables
entity_id = "E0103_SGC_gov"
url = 'http://www.southglos.gov.uk/business/tenders-and-contracts/council-payments-over-500/'
errors = 0
# Set up functions
...
block = soup.find('div', 'table-responsive')
links = block.findAll('a')
for link in links:
    url = link['href']
    csvfile = link['href'].split('/')[-1].split('.csv')[0]
    csvMth = csvfile[:3]
    csvYr = '20'+csvfile[-2:]
